            ...
            <div class="offcanvas offcanvas-start" style="width: 250px;" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav nav justify-content-end flex-grow-1  flex-column nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo basename($_SERVER['PHP_SELF']) == 'penawaran.php' ? 'active text-white' : ''; ?>"
                                aria-current="page" href="penawaran.php"><i class="fas fa-money-bill-wave-alt"></i> Penawaran</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo basename($_SERVER['PHP_SELF']) == 'lelang.php' ? 'active text-white' : ''; ?>"
                                aria-current="page" href="lelang.php"><i class="fas fa-shopping-cart"></i> Lelang</a>
                        </li>
                    </ul>
                </div>
            </div>
