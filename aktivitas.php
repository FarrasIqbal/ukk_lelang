                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-success btn-sm" data-toggle="modal"
                                data-target="#modal-buka<?php echo $d_tb_lelang['id_lelang']; ?>">Buka Lelang</button>
                            <button class="btn btn-danger btn-sm" data-toggle="modal"
                                data-target="#modal-tutup<?php echo $d_tb_lelang['id_lelang']; ?>">Tutup Lelang</button>
                        </td>
                    </tr>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                value="<?php echo $d_tb_lelang['id_lelang']; ?>" name="id_lelang"
                                                hidden="">
                                        </div>
                                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="post" action="update_lelang_tutup.php">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" value="ditutup" name="status"
                                                hidden="">
                                            <input type="text" class="form-control"
                                                value="<?php echo $d_tb_masyarakat['id_user']; ?>" name="id_user"
                                                hidden="">
                                            <input type="text" class="form-control"
                                                value="<?php echo $d_harga_tertinggi; ?>" name="harga_akhir" hidden="">
                                            <input type="text" class="form-control"
                                                value="<?php echo $d_tb_lelang['id_lelang']; ?>" name="id_lelang"
                                                hidden="">
                                        </div>
            ...
            <div class="modal fade" id="modal-tambah">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="post" action="proses/simpan_lelang.php">
                            <div class="modal-body">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" class="form-control"
                                        value="<?php echo $d_tb_petugas['id_petugas']; ?>" name="id_petugas" hidden>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="modal-footer justify-content-between">
